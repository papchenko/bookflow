          ...
          {cartCount === 0 ? (
            ...
            <div className="space-y-3">
              {cart.map(item => (
                <div
                  key={item.id}
                  className="flex flex-col md:flex-row md:items-center gap-1 md:gap-4 p-1 md:p-3 border-b"
                >
                  <img
                  ...
                  <div className="flex-grow">
                    <h3 className="font-medium text-gray-700 dark:text-gray-300 max-w-[150px] truncate">
                      {item.name}
                    </h3>
                  ...
                  {item.type === 'book' && (
                    <div className="flex flex-col gap-2 mt-2">
                      <label className="text-sm text-gray-700 dark:text-gray-300 font-medium opacity-70">Select type buying:</label>
